...
(function () {
    ...
    var SearchPane = /** @class */ (function () {
        ...
        SearchPane.prototype._buildPane = function (selectedRows, last, dataIn, init, prevEl) {
            ...
            // If it is not a custom-field pane in place
            if (this.colExists) {
                var idx = -1;
            ...
            // If it is not a custom-field pane
            if (this.colExists) {
            ...
            // If there are custom-field options set or it is a custom-field pane then get them
        ...
        /**
         * Adds the custom-field options to the pane
         *
         * @returns {Array} Returns the array of rows which have been added to the pane
         */
        SearchPane.prototype._getComparisonRows = function () {
            var colOpts = this.s.colOpts;
            // Find the appropriate options depending on whether this is a pane for a specific column or a custom-field pane
            ...
            var rows = [];
            // Clear all of the other rows from the pane, only custom-field options are to be displayed when they are defined
            this.s.dtPane.clear();
            for (var _i = 0, options_1 = options; _i < options_1.length; _i++) {
                ...
                // If a custom-field function is in place
    ...
    var SearchPanes = /** @class */ (function () {
        ...
        SearchPanes.prototype._attachPaneContainer = function () {
            ...
            // Otherwise attach the custom-field message or remove the container from the display
        ...
        SearchPanes.prototype._paneDeclare = function (table, paneSettings, opts) {
            ...
            // If there is any extra custom-field panes defined then create panes for them too
            var rowLength = table.columns().eq(0).toArray().length;
            ...
            // If a custom-field ordering is being used
