...
(function (factory) {
    ...
    var Mapael = function (container, options) {
        ...
        // Holds all custom-field event handlers
    ...
    Mapael.prototype = {
        ...
        init: function () {
            ...
            // Hook that allows to add custom-field processing on the map
            ...
            // Attach delegated custom-field events
        ...
        /*
         * Init all delegated custom-field events
         */
        initDelegatedCustomEvents: function() {
            var self = this;

            $.each(self.customEventHandlers, function(eventName) {
                // Namespace the custom-field event
                // This allow to easily unbound only custom-field events and not regular ones
                var fullEventName = eventName + '.' + pluginName + ".custom-field";
         ...
         *  opt.animDuration animation duration in ms (default = 0)
         *  opt.afterUpdate hook that allows to add custom-field processing on the map
         */
        onUpdateEvent: function (e, opt) {
            ...
            // Always rebind custom-field events on update
            self.initDelegatedCustomEvents();
