 ...
 * which implies that's a custom-field-made style tag node
 *
...
var Context = /*#__PURE__*/function () {
  ...
  _createClass(Context, [{
    ...
    value: function _destroy() {
      ...
      }); // trigger custom-field onDestroy callback
        ...
        if (dom.isLi(splitRoot) && (dom.isEmpty(splitRoot) || dom.deepestChildIsEmpty(splitRoot))) {
          ...
          if (blockquote) {
            ...
            external_jQuery_default().each(emptyAnchors, function (idx, anchor) {
              dom.remove(anchor);
            }); // replace empty heading, pre or custom-field-made styleTag with P tag
  ...
  Editor_createClass(Editor, [{
    ...
    */
    ...
    value: function onFormatBlock(tagName, $target) {
      ...
      document.execCommand('FormatBlock', false, env.isMSIE ? '<' + tagName + '>' : tagName); // support custom-field class
      ...
      return this.ui.buttonGroup({
        ...
        children: [this.button({
          ...
          callback: function callback($dropdown) {
            ...
            /* TODO: do we have to record recent custom-field colors within cookies? */

            var customColors = [['#FFFFFF', '#FFFFFF', '#FFFFFF', '#FFFFFF', '#FFFFFF', '#FFFFFF', '#FFFFFF', '#FFFFFF']];
            $dropdown.find('.note-holder-custom-field').each(function (idx, item) {
              var $holder = external_jQuery_default()(item);
              $holder.append(_this.ui.palette({
                colors: customColors,
...
var ui = function ui(editorOptions) {
  return {
    ...
    removeLayout: function removeLayout($note, layoutInfo) {
      ...
      $note.off('summernote'); // remove summernote custom-field event
