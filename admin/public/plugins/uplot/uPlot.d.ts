...
declare namespace uPlot {
	...
	export namespace Series {
		...
		/** custom-field per-datapoint styling and positioning */
		...
		export interface BarsPathBuilderOpts {
			...
			/** should return a custom-field [cached] layout for bars in % of plotting area (0..1) */
		...
		export interface Points {
			/** if boolean or returns boolean, round points are drawn with defined options, else fn should draw own custom-field points via self.ctx */
			show?: Points.Show;
