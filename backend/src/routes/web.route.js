...
let initWebRoutes = (app) => {
    ...
    router.post('/create-extra-info-user', userExtraInfoController.createUserExtraInfo)
    router.post('/update-extra-info-user', userExtraInfoController.updateUserExtraInfo);
